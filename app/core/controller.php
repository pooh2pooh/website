<?php
	...
	#
	# Методы класса:
	# isAuth — проверяет авторизован ли пользователь (true/false)
	# getLogin — возвращает имя текущего пользователя (string)
	##
	...
	class Controller {
		 ...
		 * проверяется СЕССИЯ!!!
		 * Иначе, передаваемые данные сверяются с БД
		 */
		 ...
		 * если пользователь не авторизован, вернёт false
		 */
